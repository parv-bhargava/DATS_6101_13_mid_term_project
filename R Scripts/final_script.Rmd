...
```{r data,echo=FALSE}
data <- read.csv("C:\\Users\\parvb\\Desktop\\Intro to DS\\Group Project\\group_project_r\\archive\\train.csv")
...
From the graphs above, flight distance as well as both delay variables have a strongly right-skewed distribution. This makes sense intuitively; we would expect most flights to have minimal to no delays, and shorter flights are likely more common. 
...
Departure Arrival time convenient, Food and Drinks, Online boarding, Seat comfort, Inflight Entertainment, On board service, Leg room service, Baggage handling, Checkin service, Inflight service and Cleanliness are all having a rating of 4.
Inflight wifi service, Gate location and Ease of online booking all having a rating of 3.
...
*Age:* It is noteworthy that customer satisfaction levels exhibit a correlation with age. The data suggests that older passengers tend to be more satisfied with their flights compared to their younger counterparts. This demographic trend underscores the importance of age as a factor influencing passenger contentment.

*Flight Distance:* An intriguing trend emerges when examining flight distance in relation to customer satisfaction. On average, passengers who embark on longer journeys tend to report higher levels of satisfaction. This pattern implies that extended travel distances are associated with increased contentment among passengers.

*Departure Delay in Minutes:* When exploring the relationship between departure delays and customer satisfaction, a nuanced trend becomes apparent. Flights experiencing greater departure delays appear to have a slightly higher proportion of neutral or dissatisfied customers. This suggests that prolonged delays before takeoff may have a diminishing effect on passenger contentment.

*Arrival Delay in Minutes:* A similar pattern can be observed in the context of arrival delays. Flights with higher arrival delays tend to exhibit a marginally increased prevalence of neutral or dissatisfied customers. This underscores the impact of delays, both at departure and arrival, on passenger satisfaction, highlighting the importance of timely and efficient operations to enhance the overall travel experience.
...
*Gender:* It's interesting to note that gender doesn't appear to be a significant factor in determining passenger satisfaction levels. The data indicates that both male and female passengers have fairly similar distributions of satisfaction levels. This suggests that gender does not play a prominent role in influencing the overall satisfaction of passengers.

*Customer Type:* A distinct trend emerges in terms of customer loyalty. Loyal customers, those who have a history of repeat business with the airline, tend to report higher levels of satisfaction compared to disloyal or infrequent flyers. This underscores the critical role of customer loyalty in building and maintaining high levels of satisfaction.

*Type of Travel:* The purpose of travel plays a crucial role in passenger satisfaction. Business travelers, those journeying for professional purposes, generally express higher levels of satisfaction than those traveling for personal reasons. This suggests that airlines may need to tailor their services to better meet the needs and expectations of different types of travelers.

*Class:* The class of service provided to passengers has a noticeable impact on satisfaction levels. Business class passengers stand out as notably more satisfied than those in Economy or Economy Plus. This observation highlights the importance of offering differentiated services and amenities in various travel classes to meet the diverse preferences and expectations of passengers. It also emphasizes the potential for revenue generation through premium services.
...
*Age:* The data suggests that middle-aged passengers tend to exhibit higher levels of satisfaction compared to both younger and older age groups. This observation underscores the importance of catering to the specific needs and preferences of passengers in different age categories to enhance overall customer satisfaction.

*Flight Distance:* An interesting trend emerges when considering flight distance in relation to passenger satisfaction. Passengers traveling shorter distances appear to be more inclined towards neutrality or dissatisfaction compared to those embarking on longer journeys. This insight suggests that there might be unique challenges or aspects of shorter flights that influence passenger contentment and warrant further investigation.
